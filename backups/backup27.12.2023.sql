...
--
-- Name: login_attempt; Type: TABLE; Schema: bds; Owner: postgres
--

CREATE TABLE bds.login_attempt (
...
ALTER TABLE bds.login_attempt OWNER TO postgres;

--
-- Name: login_attempt_login_attempt_id_seq; Type: SEQUENCE; Schema: bds; Owner: postgres
--

CREATE SEQUENCE bds.login_attempt_login_attempt_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE bds.login_attempt_login_attempt_id_seq OWNER TO postgres;

--
-- Name: login_attempt_login_attempt_id_seq; Type: SEQUENCE OWNED BY; Schema: bds; Owner: postgres
--

ALTER SEQUENCE bds.login_attempt_login_attempt_id_seq OWNED BY bds.login_attempt.login_attempt_id;
...
--
-- Name: login_attempt login_attempt_id; Type: DEFAULT; Schema: bds; Owner: postgres
--

ALTER TABLE ONLY bds.login_attempt ALTER COLUMN login_attempt_id SET DEFAULT nextval('bds.login_attempt_login_attempt_id_seq'::regclass);
...
8	pending	2023-12-25 19:40:22.902877	1	53	15
\.
...
--
-- Data for Name: login_attempt; Type: TABLE DATA; Schema: bds; Owner: postgres
--

COPY bds.login_attempt (login_attempt_id, ipv4, username, password_hash, is_successful) FROM stdin;
\.
...
53	Petr	Zelinka	2002-12-16	male	petr@email.com	+420702900081	6	99999	$argon2id$v=19$m=65536,t=10,p=1$oLflQGQhIigJhZt0fWjJPw$zVax/mU43aueDHPScFI8zcoPShYsA+0kBfY7XKaQOVc
\.
...
SELECT pg_catalog.setval('bds.booking_booking_id_seq', 8, true);
...
SELECT pg_catalog.setval('bds.booking_payment_booking_payment_id_seq', 5, true);
...
--
-- Name: login_attempt_login_attempt_id_seq; Type: SEQUENCE SET; Schema: bds; Owner: postgres
--

SELECT pg_catalog.setval('bds.login_attempt_login_attempt_id_seq', 1, false);
...
--
-- Name: login_attempt login_attempt_pkey; Type: CONSTRAINT; Schema: bds; Owner: postgres
--

ALTER TABLE ONLY bds.login_attempt
...
--
-- Name: TABLE login_attempt; Type: ACL; Schema: bds; Owner: postgres
--

GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE bds.login_attempt TO bds_app;


--
-- Name: SEQUENCE login_attempt_login_attempt_id_seq; Type: ACL; Schema: bds; Owner: postgres
--

GRANT SELECT,USAGE ON SEQUENCE bds.login_attempt_login_attempt_id_seq TO bds_app;
